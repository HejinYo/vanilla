...
export const appRouter = [
  {
    ...
    children: [
      {
        path: 'user', title: '用户管理', name: 'user_index', icon: 'person-stalker', component: resolve => {
        require(['@/views/system/user.vue'], resolve);
      }
      },
      {
        path: 'access', title: '权限管理', name: 'access_index', icon: 'key', component: resolve => {
  ...
  },
  {
    ...
    children: [
      {
        path: 'artical-publish', title: '文章发布', name: 'artical-publish', icon: 'compose', component: resolve => {
  ...
  // },
  {
    ...
    children: [
      {
        path: 'dragableTable', title: '可拖拽排序', name: 'dragable-table', icon: 'arrow-move', component: resolve => {
      ...
      {
        path: 'searchableTable', title: '可搜索表格', name: 'searchable-table', icon: 'search', component: resolve => {
        require(['@/views/tables/searchable-table.vue'], resolve);
      }
      },
      {
        path: 'exportableTable', title: '表格导出数据', name: 'exportable-table', icon: 'code-download', component: resolve => {
  ...
  },
  {
    ...
    children: [
      ...
      {
        path: 'argument-page', title: '带参页面', name: 'argument-page', icon: 'android-send', component: resolve => {
